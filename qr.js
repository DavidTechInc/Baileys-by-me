              ...
              if (qr) await res.end(await QRCode.toBuffer(qr));
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let md = "CRAZY;;;" + string_session;
                        let code = await sock.sendMessage(sock.user.id, { text: md });
                        let desc = `*Hello CRAZY V 3.0.0 User! 👋🏻* 
                            
> 🚨 *CONFIDENTIALITY ALERT!* 🚨

Keep your session ID under wraps! Don't share it with anyone.

Thanks for choosing CRAZY-V3 3.0.0 🚩!

*You're one step ahead!* Join our WhatsApp Channel ⤵️ (https://whatsapp.com/channel/0029VbANsvkIiRp31CEW3C2C) and get exclusive updates!*

*Ready to level up?* Fork our repo ⬇️ [https://github.com/DavidTechInc/CRAZY-V3] and contribute to the community!*
...
externalAdReply: {
title: " 𝖇𝖔𝖙 𝖈𝖔𝖓𝖓𝖊𝖈𝖙𝖊𝖉",
thumbnailUrl: "https://files.catbox.moe/sp9bds.jpeg",
